      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative z-10 border-r border-white/5">
        ...
        <div>
          ...
          <h2 className="font-display font-bold text-4xl text-white mb-4 leading-tight">
            Bienvenue sur<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-teal-400">votre espace</span>
          </h2>
        ...
        <div className="w-full max-w-md">
          <div className="glass rounded-3xl p-8 border border-white/10">
            ...
            <div className="space-y-4 mb-6">
              <div>
                <label className="block text-white/50 text-xs font-display font-bold mb-2 uppercase tracking-wider">Email</label>
              ...
              <div>
                <label className="block text-white/50 text-xs font-display font-bold mb-2 uppercase tracking-wider">Mot de passe</label>
            ...
            <div className="mt-6 pt-6 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  { email: "agent@bank.com", role: "Agent", color: "text-yellow-400" },
          ...
          <p className="text-center text-white/20 text-xs mt-4 cursor-pointer hover:text-white/40 transition-colors" onClick={() => navigate("/")}>
            ← Retour à l'accueil
          </p>
        </div>
      </div>
